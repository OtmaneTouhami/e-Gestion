...
class StagiaireRequest extends FormRequest
{
    ...
    {
        $stagiaire = $this->route('stagiaire');
        $unique = $stagiaire ? 'unique:users,presonal_email,' . $stagiaire->info->presonal_email . ',presonal_email' : 'unique:users,presonal_email';
        return [
    ...
    public function messages()
    {
        return [
            ...
            'year.required' => 'Le champ d\'année est requis.',
            'group_id.required' => 'Le champ de groupe est requis.',
        ];
    }
}
