...
function Edit({ cour, endEdit,modules }) {
    const {
            data,
            setData,
            errors,
    ...
    const submitHandler = (e) => {
        e.preventDefault();
        console.log("tesdt");
        submit("post", route("change.cour", cour.id));
    };

    const handleDragcour = (e) => {
        e.preventDefault();
