...
function Edit({ module, end }) {
    ...
    return (
        <Modal show maxWidth="2xl">
            <Head title={`Modifier ${module.name}`} />
                                ...
                                <div className="flex mt-5">
                                    <div className="flex items-center mr-4">
                                        <input
                                            ...
                                            className="w-4 h-4 text-green-500 bg-green-50 border-gray-300 focus:ring-green-500 dark:focus:ring-green-500 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                                        />
                                        <label
                                            htmlFor="technique"
